...
public class MediaMetadataRetriever {
	...
	/**
	 * The metadata key to retrieve the date when the file was created,
	 * preferably in ISO 8601.
	 */
	public static final String METADATA_KEY_CREATION_TIME = "creation_time";
	/**
	 * The metadata key to retrieve the date when the work was created,
	 * preferably in ISO 8601.
	 */
	...
	/**
	 * The metadata key to retrieve the number of this work in the set, can be
	 * in form current/total.
	 */
	public static final String METADATA_KEY_TRACK = "track";
	/**
	 * The metadata key to retrieve the total bitrate of the bitrate variant
